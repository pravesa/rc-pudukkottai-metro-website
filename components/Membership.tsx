      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="font-serif-custom text-lg text-gray-600 leading-relaxed">
            Rotary membership is more than a title — it&apos;s a commitment to making the world a better
            place. As a founding member of the Rotary Club of Pudukkottai Metro, you have the rare
            opportunity to shape this club from day one.
          </p>
        </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {benefits.map((benefit, i) => (
                <li key={i} className="flex items-start gap-3">
                  <CheckCircle size={18} className="text-[#f7a81b] mt-0.5 shrink-0" />
            ...
            <div className="mt-10 p-6 bg-[#17458f] rounded-sm text-white">
              ...
              <p className="text-white/75 text-sm mb-5">
                Reach out to us to learn more about membership and how you can be a founding
                member of the Rotary Club of Pudukkottai Metro.
              </p>
              <a href="mailto:pudukkottaimetro@gmail.com">
                <Button className="bg-[#f7a81b] hover:bg-yellow-400 text-white font-display font-bold tracking-wider uppercase rounded-sm px-6">
                  Get In Touch
                </Button>
              </a>
            </div>
          ...
          <div className="space-y-5">
            ...
            <Card className="card-hover bg-[#17458f] border-none shadow-sm rounded-none overflow-hidden mt-6">
              <CardContent className="p-6">
                <p className="font-display text-[#f7a81b] text-xs tracking-widest uppercase font-bold mb-3">
                  The Four-Way Test
                </p>
                ...
                {[
                  ...
                  <div key={i} className="flex items-start gap-3 mb-2">
                    <span className="font-display text-[#f7a81b] font-bold text-sm shrink-0">{i + 1}.</span>
